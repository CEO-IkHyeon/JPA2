...
public class OrderServiceTest {
    ...
    public void 상품주문_재고수량초과() {
        ...
        //when
        Long orderId = orderService.order(member.getId(), item.getId(), orderCount);    // Item 엔티티의 removeStock() 메소드에서 exception 발생
    ...
    // test할 때마다 객체 초기화 코드 겹치니깐 따로 method로 빼자
